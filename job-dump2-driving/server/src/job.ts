...
const START_POINT = { x: 2570.0571, y: 2719.7012, z: 41.877686 };
const TOTAL_DROP_OFFS = 2;

export class Dump2Job {
    /**
    ...
    static async begin(player: alt.Player) {
        const openSpot = await Dump2Job.getVehicleSpawnPoint();
        if (!openSpot) {
            Athena.player.emit.notification(player, `~r~No room for vehicles right now. Please wait...`);
            return;
        }

        const randomPoints1 = Dump2Job.getRandomPoints1(TOTAL_DROP_OFFS);
        ...
        const randomPoints2 = Dump2Job.getRandomPoints2(TOTAL_DROP_OFFS);
        ...
        const randomPoints3 = Dump2Job.getRandomPoints3(TOTAL_DROP_OFFS);
        ...
        const randomPoints4 = Dump2Job.getRandomPoints4(TOTAL_DROP_OFFS);
        ...
        const randomPoints5 = Dump2Job.getRandomPoints5(TOTAL_DROP_OFFS);
        ...
        const randomPoints6 = Dump2Job.getRandomPoints6(TOTAL_DROP_OFFS);
        ...
        const randomPoints7 = Dump2Job.getRandomPoints7(TOTAL_DROP_OFFS);
